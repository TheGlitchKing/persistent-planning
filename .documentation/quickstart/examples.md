...
### Loop 0: Setup
```bash
/start-planning "Morning exercise benefits research"
```

### Loop 1: Create Plan
```bash
Write .planning/morning-exercise-benefits-research/task_plan.md
```
...
### Loop 2: Research
```bash
Read .planning/morning-exercise-benefits-research/task_plan.md  # Refresh goals
WebSearch "morning exercise benefits"
Write .planning/morning-exercise-benefits-research/notes.md     # Store findings
Edit .planning/morning-exercise-benefits-research/task_plan.md  # Mark Phase 2 complete
```

### Loop 3: Synthesize
```bash
Read .planning/morning-exercise-benefits-research/task_plan.md  # Refresh goals
Read .planning/morning-exercise-benefits-research/notes.md      # Get findings
Write morning_exercise_summary.md                                # Deliverable
Edit .planning/morning-exercise-benefits-research/task_plan.md  # Mark Phase 3 complete
```

### Loop 4: Deliver
```bash
Read .planning/morning-exercise-benefits-research/task_plan.md  # Verify complete
...
### .planning/fix-login-bug/task_plan.md
```markdown
...
**.planning/add-dark-mode/task_plan.md:**
```markdown
...
**.planning/add-dark-mode/notes.md:**
```markdown
...
-> Read .planning/[task]/task_plan.md   # Brings goals back into attention
...
When your task is complete, clean up the planning files:
...
This removes planning files while keeping your deliverables in the project directory.
